...
impl <'a> ::pnet::packet::PacketSize for VlanPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 4 }
}
impl <'a> ::pnet::packet::PacketSize for MutableVlanPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 4 }
}
impl <'a> ::pnet::packet::MutablePacket for MutableVlanPacket<'a> {
    #[inline]
...
impl <'a> ::pnet::packet::Packet for MutableVlanPacket<'a> {
    #[inline]
...
impl <'a> ::pnet::packet::Packet for VlanPacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'p> ::pnet::packet::FromPacket for VlanPacket<'p> {
    type
    T
    =
    Vlan;
...
impl <'p> ::pnet::packet::FromPacket for MutableVlanPacket<'p> {
    type
    T
    =
    Vlan;

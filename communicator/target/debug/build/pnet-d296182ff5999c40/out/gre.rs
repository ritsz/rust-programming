...
pub struct MutableGrePacket<'p> {
    packet: ::pnet::packet::MutPacketData<'p>,
}
impl <'a> GrePacket<'a> {
...
impl <'a> ::pnet::packet::PacketSize for GrePacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'a> ::pnet::packet::PacketSize for MutableGrePacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize {
        let _self = self;
        4 + gre_checksum_length(&_self.to_immutable()) +
...
impl <'a> ::pnet::packet::MutablePacket for MutableGrePacket<'a> {
    #[inline]
...
impl <'a> ::pnet::packet::Packet for MutableGrePacket<'a> {
    #[inline]
...
impl <'a> ::pnet::packet::Packet for GrePacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'p> ::pnet::packet::FromPacket for GrePacket<'p> {
    type
    T
    =
    Gre;
...
impl <'p> ::pnet::packet::FromPacket for MutableGrePacket<'p> {
    type
    T
    =
    Gre;
...
impl <'a> ::pnet::packet::PacketSize for U16BEPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 2 + 0 }
}
impl <'a> ::pnet::packet::PacketSize for MutableU16BEPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 2 + 0 }
}
impl <'a> ::pnet::packet::MutablePacket for MutableU16BEPacket<'a> {
    #[inline]
    fn packet_mut<'p>(&'p mut self) -> &'p mut [u8] { &mut self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'a> ::pnet::packet::Packet for MutableU16BEPacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'a> ::pnet::packet::Packet for U16BEPacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'p> ::pnet::packet::FromPacket for U16BEPacket<'p> {
    type
    T
    =
    U16BE;
...
impl <'p> ::pnet::packet::FromPacket for MutableU16BEPacket<'p> {
    type
    T
    =
    U16BE;
...
impl <'a> ::pnet::packet::PacketSize for U32BEPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 4 + 0 }
}
impl <'a> ::pnet::packet::PacketSize for MutableU32BEPacket<'a> {
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
    fn packet_size(&self) -> usize { let _self = self; 4 + 0 }
}
impl <'a> ::pnet::packet::MutablePacket for MutableU32BEPacket<'a> {
    #[inline]
    fn packet_mut<'p>(&'p mut self) -> &'p mut [u8] { &mut self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'a> ::pnet::packet::Packet for MutableU32BEPacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'a> ::pnet::packet::Packet for U32BEPacket<'a> {
    #[inline]
    fn packet<'p>(&'p self) -> &'p [u8] { &self.packet[..] }
    #[inline]
    #[cfg_attr(feature = "clippy", allow(used_underscore_binding))]
...
impl <'p> ::pnet::packet::FromPacket for U32BEPacket<'p> {
    type
    T
    =
    U32BE;
...
impl <'p> ::pnet::packet::FromPacket for MutableU32BEPacket<'p> {
    type
    T
    =
    U32BE;
